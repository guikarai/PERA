#COLLECT INFORMATION ABOUT A CENTOS, RHEL OR CLESOS LINUX ENVIRONMENT
...
rpm -qa | grep libica >> PERDA.LINUX.txt
...
sudo yum search opencryptoki >> PERDA.LINUX.txt
...
rpm -qa | grep openssl-ibmca >> PERDA.LINUX.txt
